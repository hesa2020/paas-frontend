    ...
    return (
      <div>
        <h4>
          ...
          <NewTabLink url="https://agent.com/docs/app-configuration.html#persistent-or-not">
  ...
  render() {
    ...
    return (
      <div>
        ...
        <h4>
          Port Mapping &nbsp;
          <NewTabLink url="https://agent.com/docs/app-configuration.html#port-mapping">
            <Icon type="info-circle" />
          </NewTabLink>
        </h4>
        <div
        ...
        <Row>
          ...
          <h4>
            Pre-Deploy Script
            <NewTabLink url="https://agent.com/docs/pre-deploy-script.html">
