...
> {
  ...
  fetchLogs() {
    ...
    const separators = [
      ...
      "01000000",
      "02000000",
      "03000000" // This is not in the Docker docs, but can actually happen when the log stream is broken https://github.com/agent/agent/issues/366
    ];
                ...
                <Row type="flex" justify="start" align="middle">
                  ...
                  <span style={{ marginLeft: 20, paddingBottom: 3 }}>
                    <Tooltip title="View full application logs (not truncated)">
                      <NewTabLink url="https://agent.com/docs/troubleshooting.html#how-to-view-my-applications-log">
