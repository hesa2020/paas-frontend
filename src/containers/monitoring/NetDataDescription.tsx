    ...
    return (
      <div>
        ...
        <p>
          ...
          embeded in Agent uses a default configuration for
          <NewTabLink url="https://docs.netdata.cloud/docs/anonymous-statistics/">
           &nbsp;statistics
          </NewTabLink>
          . You can recompile Agent with a different customized image if
          you'd like.
        </p>
        <p>
          Agent provides a simple interface to enable NetData on your
          Agent instance. Currently, Agent only supports installing
          NetData on your <b>leader node</b>, i.e., the node where Agent
