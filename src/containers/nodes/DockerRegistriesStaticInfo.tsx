    ...
    return (
      <div>
        <p>
          ...
          your Agent on a cluster. For single node Agent deployments,
          Docker Registry is not recommended as it makes deployment
        ...
        <Collapse>
          <Collapse.Panel header="More info" key="1">
            ...
            <p>
              Agent provides two methods for you to setup your docker
              registry:
            </p>
            <ul>
              <li>
                <b>Self hosted Docker Registry:</b> This is the simplest way to
                setup a docker registry. Agent creates an instance of Docker
